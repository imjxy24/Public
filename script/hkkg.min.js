function initHamsterKeyGenerator(){let e=document.querySelector(".hamster-key-generator"),t={1:{name:"Riding Extreme 3D",appToken:"d28721be-fd2d-4b45-869e-9f253b554e50",promoId:"43e35910-c168-4634-ad4f-52fd764a843f",timing:3e4,attempts:25},2:{name:"Chain Cube 2048",appToken:"d1690a07-3780-4068-810f-9b5bbf2931b2",promoId:"b4170868-cef0-424f-8eb9-be0622e8e8e3",timing:3e4,attempts:20},3:{name:"My Clone Army",appToken:"74ee0b5b-775e-4bee-974f-63e7f4d5bacb",promoId:"fe693b26-b342-4159-8808-15e3ff7f8767",timing:18e4,attempts:30},4:{name:"Train Miner",appToken:"82647f43-3f87-402d-88dd-09a90025313f",promoId:"c4480ac7-e178-4973-8061-9ed5b2e17954",timing:3e4,attempts:15},5:{name:"Merge Away",appToken:"8d1cc2ad-e097-4b86-90ef-7a27e19fb833",promoId:"dc128d28-c45b-411c-98ff-ac7726fbaea4",timing:3e4,attempts:25},6:{name:"Twerk Race 3D",appToken:"61308365-9d16-4040-8bb0-2f4a4c69074c",promoId:"61308365-9d16-4040-8bb0-2f4a4c69074c",timing:3e4,attempts:20},7:{name:"Polysphere",appToken:"2aaf5aee-2cbc-47ec-8a3f-0962cc14bc71",promoId:"2aaf5aee-2cbc-47ec-8a3f-0962cc14bc71",timing:2e4,attempts:20},8:{name:"Mow and Trim",appToken:"ef319a80-949a-492e-8ee0-424fb5fc20a6",promoId:"ef319a80-949a-492e-8ee0-424fb5fc20a6",timing:2e4,attempts:20},9:{name:"Mud Racing",appToken:"8814a785-97fb-4177-9193-ca4180ff9da8",promoId:"8814a785-97fb-4177-9193-ca4180ff9da8",timing:2e4,attempts:20},10:{name:"Cafe Dash",appToken:"bc0971b8-04df-4e72-8a3e-ec4dc663cd11",promoId:"bc0971b8-04df-4e72-8a3e-ec4dc663cd11",timing:2e4,attempts:20}},a=e.querySelectorAll(".game-option"),n=e.querySelector("#keyCountGroup"),i=e.querySelector("#keyRange"),r=e.querySelector("#keyValue"),o=e.querySelector("#startBtn"),d=e.querySelector("#progressContainer"),s=e.querySelector("#progressBar"),c=e.querySelector("#progressText"),l=e.querySelector("#progressLog"),$=e.querySelector("#keyContainer"),p=e.querySelector("#keysList"),m=e.querySelector("#copyAllBtn"),y=e.querySelector("#generatedKeysTitle"),f=e.querySelector("#copyStatus"),u=e.querySelector("#generateMoreBtn"),h=e.querySelector("#gameSelectContainer"),b=null;a.forEach(e=>{e.addEventListener("click",()=>{a.forEach(e=>e.classList.remove("selected")),e.classList.add("selected"),b=e.dataset.game,n.classList.remove("hidden"),o.classList.remove("hidden")})}),i.addEventListener("input",()=>{r.innerText=i.value});let _=async()=>{let a=parseInt(i.value);if(!b){alert("Please select a game first.");return}let r=parseInt(b),f=t[r];h.classList.add("hidden"),n.classList.add("hidden"),o.classList.add("hidden"),u.classList.add("hidden"),$.classList.add("hidden"),s.style.width="0%",c.innerText="0%",l.innerText="Starting...",d.classList.remove("hidden");let _=0,v=(e,t)=>{_+=e,s.style.width=`${_}%`,c.innerText=`${Math.round(_)}%`,l.innerText=t},w=async()=>{let e=g(),t;try{t=await x(e,f.appToken)}catch(n){return alert(`Failed to login: ${n.message}`),null}for(let i=0;i<f.attempts;i++){let r=await k(t,f.promoId);if(v(100/f.attempts/a,"Generating keys..."),r)break;await T(f.timing)}try{let o=await L(t,f.promoId);return v(100/a,"Generating key..."),o}catch(d){return alert(`Failed to generate key: ${d.message}`),null}},C=await Promise.all(Array.from({length:a},w));C.length>1?(p.innerHTML=C.filter(e=>e).map(e=>`<div class="key-item">
